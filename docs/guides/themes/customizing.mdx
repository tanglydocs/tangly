...
See [Schema → Colors](/reference/schema) for the full token table.
...
See [Schema → Fonts & styling](/reference/schema).
...
See [`tangly eject`](/reference/cli) for what gets written and how to roll back if you regret it.
...
| Render a different OpenAPI viewer | [Schema → API](/reference/schema): no customization needed, just `api.viewer` |
