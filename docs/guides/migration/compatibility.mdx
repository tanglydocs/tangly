...
One caveat remains: a snippet that itself uses MDX components doesn't yet inherit the global component set (those components render undefined). See [What's not in Tangly yet](#whats-not-in-tangly-yet).
