...
The default modal is a single Astro file at `@tangly/theme-tang/SearchModal.astro` (or `theme-pith/`). Drop an override at `./components/SearchModal.astro` in your project to replace it; component shadowing routes the import there.
