...
description: Tangly is built for the agent-assisted era. Skills for Claude Code, JSON Schema for Cursor, llms.txt for everything else.
icon: "bot"
---
...
Read [Skills](/guides/ai-agents/skills) first if you're using Claude Code. [Cursor & others](/guides/ai-agents/cursor-and-others) if you're not. [Conventions](/guides/ai-agents/conventions) once you're past the basics and want to teach the agent your project's specifics.
