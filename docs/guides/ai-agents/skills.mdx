...
Tangly ships two skills under [`skills/`](https://github.com/tanglydocs/tangly/tree/main/skills) in the repo. They follow the [agent-skills convention](https://github.com/anthropics/agent-skills): Markdown files with frontmatter that any skill-aware agent (Claude Code, Codex, …) loads on demand and uses to scope its behavior.
...
The skills follow the [agent-skills convention](https://github.com/anthropics/agent-skills). Install both globally with one command:
