---
title: Introduction
description: A self-hosted, agent-native documentation framework. Markdown in, deployable site out — on your terms.
icon: "sparkles"
---

# Tangly

Tangly is a documentation framework you self-host. Point it at a directory of MDX files, get a fast, themed, deployable site. Built on Astro, MDX, and Tailwind v4 — no proprietary runtime, no vendor lock-in, no monthly bill.
