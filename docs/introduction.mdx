...
- **Fast dev server.** Astro 6 + Vite under the hood. HMR under 250ms, cold start under 2s on a hundred pages. `tangly dev` boots in the time `mintlify dev` spends loading.
